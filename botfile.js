const port = process.env.BOTPRESS_PORT || process.env.PORT || 3300;
...
module.exports = {
  ...
  */
  ...
  ghostContent: {
    enabled:
      ...
      process.env.BOTPRESS_GHOST_ENABLED
  },
  ...
  */
  postgres: {
    ...
    password: process.env.PG_PASSWORD || 'report123',
    database: process.env.PG_DB || 'vajrodb',
